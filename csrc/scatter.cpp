...
static auto registry = torch::RegisterOperators()
                           .op("my_scatter::scatter_sum", &scatter_sum)
                           .op("my_scatter::scatter_mean", &scatter_mean)
                           .op("my_scatter::scatter_min", &scatter_min)
                           .op("my_scatter::scatter_max", &scatter_max);
